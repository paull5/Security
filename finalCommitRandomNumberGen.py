...
subtracted by 1 is perfectly divisible by m).this is called finding the multiplicative inverse of a number modulo 'n',
for which we will be using extended Euclidean algorithm
...
def decrypt():
    ...
    decryptedText = rsa(encryptedtext1, b, n)
